...
public class TimeFlowCase {
    ...
    public void setContent(final String c) { this.content = c; }

    public String getGmt() { return gmt; }

    public void setGmt(final String t) { this.gmt = t; }

    public String getModified() { return modified; }

    public void setModified(final String m) { this.modified = m; }
